...
class BadPriorityError(Exception):
    ...
    def __init__(self, head="ToDoPriorityError", message="Bad priority."):
        ...
        Args:
            ...
            message: Text with error message. Default value: "Bad priority.".
...
class BadIdError(Exception):
    ...
    def __init__(self, head="ToDoTaskIDError", message="Bad task ID."):
        ...
        Args:
            ...
            message: Text with error message. Default value: "Bad task ID.".
...
class BadNameError(Exception):
    ...
    def __init__(self, head="ToDoTaskNameError", message="Bad task name."):
        ...
        Args:
            ...
            message: Text with error message. Default value: "BBad task name.".
...
class Client_ToDo:
    ...
    def get_tasks(self, query=""):
        ...
        and passed to the show method when status code is OK.
    ...
    def get_task_by_id(self):
        ...
        Raises:
            BadIdError: Error occurred taking task ID from a user
            and converting ID to integer.
        """
        try:
    ...
    def add_task(self):
        ...
        ID, NAME, PRIORITY get from user's input
        and converted to JSON for request body.
        Response is converted to JSON
        and passed to the show method when status code is OK.
        ...
        Raises:
            ...
            BadPriorityError: Error occurred taking task PRIORITY from a user
            and converting PRIORITY to integer.
        """
        new_task = {}
    ...
    def change_task(self):
        ...
        if len(task_to_change.get("name")) <= 5:
            raise BadNameError(message="More than 5 characters!")
    ...
    def delete_task(self):
        ...
        """
        try:
            to_delete = int(input("Task ID: "))
        except:
            raise BadIdError

        try:
            reply = requests.delete(f"http://localhost:3000/tasks/{to_delete}")
            reply = requests.get("http://localhost:3000/tasks/")
        except requests.RequestException:
            print("Communication error")
        else:
    ...
    def close_connection(self):
        """Close conection by HTTP request header
        and show info message for user aboit this.
        """
        try:
            reply = requests.head(
                "http://localhost:3000/tasks/",
            ...
            if (
                ...
                print("Connection are closed successfully.")
            elif reply.status_code == requests.codes.not_found:
                print("Resource not found")
            else:
                print("Server error")
...
if __name__ == "__main__":
    print("main.py - independent module.\n")
    main()
else:
    print("main.py - imported module.")
